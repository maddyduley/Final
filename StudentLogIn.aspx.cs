    ...
    public partial class StudentLogIn : System.Web.UI.Page
    {
        ...
        {// test the entered values to see if they exist
            ...
            try
            {
                ...
                loginCommand.Parameters.AddWithValue("@UserName", HttpUtility.HtmlEncode(txtUsername.Text.ToString()));
                loginCommand.Parameters.AddWithValue("@PassWord", HttpUtility.HtmlEncode(txtPassword.Text.ToString()));
                sc.Open();
