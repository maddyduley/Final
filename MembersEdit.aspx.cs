        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection sc = new SqlConnection(WebConfigurationManager.ConnectionStrings["Lab3"].ConnectionString.ToString()))
                {
                    ...
                    cmd.Connection = sc;
                    cmd.CommandText = "UPDATE Member SET FirstName=@FName,LastName=@LName,Email=@EMAIL,PhoneNumber=@PhoneNum,Title=@Title,GradYear=@Grad,Type='" + TypeList.SelectedValue + "' WHERE MemberID ='" + MentorNameList.SelectedValue + "'";
        ...
        {
            {
                ...
                String sqlFirst = "Select FirstName,LastName,Email,PhoneNumber,GradYear,Title,Type From Member WHERE MemberID='" + MentorNameList.SelectedValue + "'";
