...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
     Internship Title:
            ...
            <br />
            Start Date:
            <asp:TextBox ID="DateStart" runat="server" placeholder="XX/XX/XXXX XX:XX:XX XM"></asp:TextBox>
            ...
            <br />
            End Date:
            <asp:TextBox ID="DateEnd" runat="server" placeholder="XX/XX/XXXX XX:XX:XX XM"></asp:TextBox>
    ...
    <br />
    <asp:Button ID="CreateJobs" runat="server" Text="Create" OnClick="CreateJobs_Click" CausesValidation="false" />
</asp:Content>
