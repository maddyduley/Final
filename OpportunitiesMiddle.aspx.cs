...
namespace Lab3
{
    public partial class OpportunitiesMiddle : System.Web.UI.Page
    {
        ...
        protected void Opportunities_Click(object sender, EventArgs e)
        {
            Response.Redirect("EditOpportunity.aspx");
        }
