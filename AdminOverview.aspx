...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                          <br />
    <div class="center">
                          <asp:Button ID="Messages" runat="server" Text="Inbox" Onclick="Messages_Click" Height="48px" Width="133px"  />    </div>
    <br />
    ...
    <br />
    <br />
    <asp:Button ID="Engagementbtn" runat="server" Text="Engagement" OnClick="Engagementbtn_Click" CssClass="rightbuttons" Height="65px" Width="200px" />
        <br />
        <br />
