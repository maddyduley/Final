...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:Button ID="DeleteStudenAcc" runat="server" Text="Deny Student Application" OnClick="DeleteStudenAcc_Click" />
    <br />
    ...
    <asp:Button ID="DenyMemberAcc" runat="server" Text="Deny Member Application" OnClick="DenyMemberAcc_Click" />
