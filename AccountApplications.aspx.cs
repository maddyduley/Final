    ...
    public partial class AccountApplications : System.Web.UI.Page
    {
        ...
        protected void AcceptMemberAcc_Click(object sender, EventArgs e)
        {
            {//pass all of the data from the application into the correct table to be accepted
                ...
                string emailstat = "Select EmailStat from  MemberAccountApplication WHERE MemberAccAppID=" + MemberListDrop.SelectedValue;
                ...
                SqlCommand EmailStatCommand = new SqlCommand(emailstat, sqlconnect);
                ...
                try
                {
                    ...
                    String EmailstatVar = (EmailStatCommand.ExecuteScalar().ToString());
                    Session["EmailStat"] = EmailstatVar;
                    ...
                    {//insert the variables into the member table (Member type is automatically just a member because priveledge escalation should be done manually in case of someone get unauthorized access) 
                        string Inserted = "Insert INTO MEMBER VALUES ('" + Session["Firsts"].ToString() + "','" + Session["Lasts"].ToString() + "','" + Session["Emailed"].ToString() + "','" + Session["Phon"].ToString() + "'," + Session["Gradss"].ToString() + ",'" + Session["Tittle"].ToString() + "','" + Session["EmailStat"].ToString() + "','" + Session["Use"].ToString() + "','" + TypeList.Text + "','Null.png')";
                    ...
                    String sqlQuerysd = "Delete FROM MemberAccountApplication WHERE MemberAccAppID =" + MemberListDrop.SelectedValue;
        ...
        protected void AcceptStudentAcc_Click(object sender, EventArgs e)
        {
            {//pass all of the data from the application into the correct table to be accepted
                ...
                string emailstat = "Select EmailStat from  StudentAccountApplication WHERE StudentAccAppID=" + StudentListDrop.SelectedValue;
                ...
                try
                {
                    ...
                    {//insert the variables into the member table
                        string Inserted = "Insert INTO Student VALUES ('" + Session["Firsts"].ToString() + "','" + Session["Lasts"].ToString() + "','" + Session["Emailed"].ToString() + "','" + Session["Phon"].ToString() + "','" + Session["Univer"].ToString() + "','" + Session["Majs"].ToString() + "'," + Session["Gradss"].ToString() + ",'" + Session["EmailStat"].ToString() + "','" + Session["Use"].ToString() + "','Resume.pdf','Null.png')";
                    ...
                    SqlConnection sqlConnectd = new
                   SqlConnection(WebConfigurationManager.ConnectionStrings["Lab3"].ConnectionString.ToString());
                    String sqlQuerysd = "Delete FROM StudentAccountApplication WHERE StudentAccAppID =" + StudentListDrop.SelectedValue;
        ...
        protected void DenyMemberAcc_Click(object sender, EventArgs e)
        {
            SqlConnection sqlConnectd = new
                   SqlConnection(WebConfigurationManager.ConnectionStrings["Lab3"].ConnectionString.ToString());
            String sqlQuerysd = "Delete FROM StudentAccountApplication WHERE StudentAccAppID =" + StudentListDrop.SelectedValue;
            ...
            commandds.ExecuteNonQuery();
            sqlConnectd.Close();
            AcceptStudentResult.Text = "Application Deleted Successfully";
        }

        protected void DeleteStudenAcc_Click(object sender, EventArgs e)
        {
            SqlConnection sqlConnectd = new
SqlConnection(WebConfigurationManager.ConnectionStrings["Lab3"].ConnectionString.ToString());
            String sqlQuerysd = "Delete FROM MemberAccountApplication WHERE MemberAccAppID =" + MemberListDrop.SelectedValue;
            ...
            commandds.ExecuteNonQuery();
            sqlConnectd.Close();
            AcceptMemberResult.Text = "Application Deleted Successfully";
        }
    }
}
