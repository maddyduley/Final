    ...
    public partial class UserStudentEdit : System.Web.UI.Page
    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection sc = new SqlConnection(WebConfigurationManager.ConnectionStrings["Lab3"].ConnectionString.ToString()))
            {
                ...
                cmd.Connection = sc;
                cmd.CommandText = "UPDATE Student SET FirstName=@FName,LastName=@LName,Email=@EMAIL,PhoneNumber=@PhoneNum,UniversityYear=@Univ,Major=@MAJ,GradYear=@Grad,EmailStat='" + EmailList.SelectedValue + "' WHERE UserName ='" + Session["Username"].ToString() + "'";
