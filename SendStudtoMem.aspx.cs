...
namespace Lab3
{
    public partial class SendStudtoMem : System.Web.UI.Page
    {
        ...
        protected void Send_Click(object sender, EventArgs e)
        {
            ...
            {//insert all of the values into the login table
                string Inserting = "Insert INTO MessagesStudToMem VALUES (@Title,'" + DateTime.Now.ToString("MM/dd/yyyy h:mm:ss tt") + "',@Message," + Session["Student"].ToString() + "," + MemberList.SelectedValue + ")";
