    ...
    <asp:GridView ID="JobList" runat="server" AutoGenerateColumns="False" DataSourceID="Schodata">
        <Columns>
            ...
            <asp:BoundField DataField="ScholarshipApplicationDescription" HeaderText="ScholarshipApplicationDescription" SortExpression="ScholarshipApplicationDescription" />
               ...
               <itemTemplate>
                   <asp:HyperLink ID="reumesss" Target="_blank" runat="server" NavigateUrl='<%# "/TextFile/" + Eval("ScholarshipApplicationResume") %>'>Resume</asp:HyperLink>
               </itemTemplate>
           </asp:TemplateField>
        </Columns>
        </asp:GridView>
        <asp:SqlDataSource ID="Schodata" runat="server" ConnectionString="<%$ ConnectionStrings:Lab3 %>" SelectCommand="SELECT Scho.ScholarshipName, Stu.FirstName + ' '+ Stu.LastName AS FullName, Scap.ScholarshipApplicationDate, Scap.ScholarshipApplicationDescription,Scap.ScholarshipApplicationResume From Student Stu, Scholarship Scho, ScholarshipApplication Scap WHERE Stu.StudentID=Scap.StudentID AND Scho.ScholarshipID=Scap.ScholarshipID">
        </asp:SqlDataSource>
    <br />
